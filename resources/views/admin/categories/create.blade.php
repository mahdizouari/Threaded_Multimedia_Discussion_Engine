...
@section('title', 'Create Category — Pulse')
...
<div class="category-form-container" style="max-width: 600px; margin: 40px auto; padding: 20px;">
    <div class="glass-panel" style="padding: 40px; border-radius: var(--radius-lg); border: 1px solid var(--border-glass); background: var(--bg-glass); box-shadow: var(--shadow-lg);">
        <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 32px;">
            ...
            <div>
                <h1 style="font-size: 24px; font-weight: 800; color: var(--text-primary); margin-bottom: 2px;">New Category</h1>
                <p style="font-size: 14px; color: var(--text-muted);">Define a new community space</p>
            </div>
        </div>
        ...
        <form action="{{ route('categories.store') }}" method="POST">
            ...
            <div class="form-group" style="margin-bottom: 24px;">
                ...
                <input type="text" name="label" id="label" placeholder="e.g. Technology, Music, Gaming" required
            ...
            <div class="form-group" style="margin-bottom: 32px;">
                ...
                <textarea name="description" id="description" rows="4" placeholder="What is this community about?"
                    ...
                    onfocus="this.style.borderColor='var(--accent-primary)'; this.style.boxShadow='0 0 0 4px rgba(124, 58, 237, 0.1)';" 
                    onblur="this.style.borderColor='rgba(0,0,0,0.1)'; this.style.boxShadow='none';">{{ old('description') }}</textarea>
                @error('description')
                    <span style="color: #ef4444; font-size: 12px; margin-top: 6px; display: block;">{{ $message }}</span>
                @enderror
            </div>
